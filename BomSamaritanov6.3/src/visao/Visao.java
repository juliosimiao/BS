...
public class Visao extends javax.swing.JFrame implements Observer {
    ...
    private final String TESTECONEXAO;
    ...
    public Visao(Interno modelo) throws IOException {
        ...
        TESTECONEXAO = jMenuTesteConexao.getActionCommand();
    ...
    public void limpaCampos(JPanel jp) {
        ...
        for (Component comp : jp.getComponents()) {
            if (comp instanceof JTextField) {
                ...
                ((JDateChooser) comp).setDateFormatString(null);
            } else if (comp instanceof JFormattedTextField) {
...
//habilita novo registro
    ...
    public void updateAbaInterno() {
        ...
        getjDCDataNascimento().setDateFormatString(getModelo().getDataNascimento());
...
//        setIconeFoto(fotoantes.getPath(), fotoantes.getPath(),jLFotoAntes.getWidth(), jLFotoAntes.);
    ...
    public void updateAbaQuestionario() {
        ...
        getjDCDataEntradaClinica().setDateFormatString(getModelo().getTratamentosAnteriores().getDataEntrada());
        getjDCDataSaidaClinica().setDateFormatString(getModelo().getTratamentosAnteriores().getDataSaida());
    ...
    public void updateAbaOutrasInformacoes() {
        ...
        getjDCEntrevistaUm().setDateFormatString(getModelo().getProcesso().getDataUm());
        getjDCEntrevistaDois().setDateFormatString(getModelo().getProcesso().getDataDois());
        getjDCEntrevistaInternamento().setDateFormatString(getModelo().getProcesso().getDataInternamento());
        getjDCEntrevistaSaida().setDateFormatString(getModelo().getProcesso().getDataSaida());
...
//                    ((JTextField) comp).setText(ini);
    ...
    private void initComponents() {
        ...
        jPDadosPessoaisLayout.setVerticalGroup(
            ...
            .addGroup(jPDadosPessoaisLayout.createSequentialGroup()
                ...
                .addGroup(jPDadosPessoaisLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPDadosPessoaisLayout.createSequentialGroup()
                        .addGap(0, 0, Short.MAX_VALUE)
                        .addComponent(jDCDataNascimento, javax.swing.GroupLayout.PREFERRED_SIZE, 24, javax.swing.GroupLayout.PREFERRED_SIZE)))
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addGroup(jPDadosPessoaisLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(jLNaturalidade)
        ...
        jPInternoGeralLayout.setVerticalGroup(
            ...
            .addGroup(jPInternoGeralLayout.createSequentialGroup()
                ...
                .addGroup(jPInternoGeralLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(jPFoto, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addGroup(jPInternoGeralLayout.createSequentialGroup()
                        .addComponent(jPDadosPessoais, javax.swing.GroupLayout.PREFERRED_SIZE, 115, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
        ...
        jPProcessoLayout.setHorizontalGroup(
            ...
            .addGroup(jPProcessoLayout.createSequentialGroup()
                ...
                .addGroup(jPProcessoLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(jFTEntrevistadoraUm)
        ...
        jPOutrasInformacoesGeralLayout.setVerticalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPOutrasInformacoesGeralLayout.createSequentialGroup()
                ...
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(jPProcesso, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
        ...
        jTPAbas.addTab("Dados Boleto", jPBoleto);

        jPanel1.setBorder(javax.swing.BorderFactory.createTitledBorder("Qual relatório deseja gerar?"));

        jLabel4.setFont(new java.awt.Font("Tahoma", 0, 36)); // NOI18N
        jLabel4.setForeground(new java.awt.Color(255, 0, 0));
        jLabel4.setText("EM DESENVOLVIMENTO");
    ...
    public void eventoClicjTPesquisa() {
        ...
        //Aba Interno
        getjTFID().setText(getInterno().get(linha).getCodigo() + "");
        getjFTNome().setText(getInterno().get(linha).getNome());
        getjDCDataNascimento().setDateFormatString(getInterno().get(linha).getDataNascimento());
...
//        jFTResponsavel.setText(getInterno().get(linha).getResponsavel());
        ...
        getjDCEntrevistaUm().setDateFormatString(getInterno().get(linha).getProcesso().getDataUm());
        getjDCEntrevistaDois().setDateFormatString(getInterno().get(linha).getProcesso().getDataDois());
        getjDCEntrevistaInternamento().setDateFormatString(getInterno().get(linha).getProcesso().getDataInternamento());
        getjDCEntrevistaSaida().setDateFormatString(getInterno().get(linha).getProcesso().getDataSaida());
        ...
        getjDCDataEntradaClinica().setDateFormatString(getInterno().get(linha).getTratamentosAnteriores().getDataEntrada());
        getjDCDataSaidaClinica().setDateFormatString(getInterno().get(linha).getTratamentosAnteriores().getDataSaida());
